...
- (void)doSelectServerAndLogin
{
    ...
    TNV_MainTableViewController *viewController = [((UINavigationController *)[tabBarController.viewControllers objectAtIndex:0]).viewControllers objectAtIndex:0];
...
- (void)setAddBarButtonEnable:(BOOL)enable
{
    ...
    TNV_MainTableViewController *myCamerasTableViewController = [((UINavigationController *)[tabBarController.viewControllers objectAtIndex:0]).viewControllers objectAtIndex:0];
}
